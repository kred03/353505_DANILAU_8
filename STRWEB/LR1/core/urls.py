...
urlpatterns = [
    ...
    # Маршруты на «голые» HTML
    path('cart/', views.cart_view, name='cart-min'),
    path('checkout/', TemplateView.as_view(template_name='checkout.html'), name='checkout-min'),
    path('product/', TemplateView.as_view(template_name='product.html'), name='product-min'),
    path('about-min/', TemplateView.as_view(template_name='about.html'), name='about-min'),
    path('news-min/', TemplateView.as_view(template_name='news.html'), name='news-min'),
    path('faq-min/', TemplateView.as_view(template_name='faq.html'), name='faq-min'),
    path('contacts-min/', TemplateView.as_view(template_name='contacts.html'), name='contacts-min'),
    path('privacy-min/', TemplateView.as_view(template_name='privacy.html'), name='privacy-min'),
    path('vacancies-min/', TemplateView.as_view(template_name='vacancies.html'), name='vacancies-min'),
    path('reviews-min/', TemplateView.as_view(template_name='reviews.html'), name='reviews-min'),
    path('promocodes-min/', TemplateView.as_view(template_name='promocodes.html'), name='promocodes-min'),

    # Новости из БД — без оформления
    path('news-db/', views.NewsListViewMinimal.as_view(), name='news-db-list'),
    path('news-db/<int:pk>/', views.NewsDetailViewMinimal.as_view(), name='news-db-detail'),

    # FAQ из БД — список с раскрытием
    path('faq-db/', views.FAQListViewMinimal.as_view(), name='faq-db-list'),
